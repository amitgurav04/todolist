...
import (
	...
	"github.com/amitgurav04/todolist/restapi/operations"
	"github.com/amitgurav04/todolist/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../todolist --name TodoList --spec ../swagger.yml --principal interface{}
